...
import com.example.financialapp.adapters.inbound.TransactionController;
...
class TransactionControllerTest {
    ...
    void testGetTransactionByIdNotFound() {
        // Given
        when(transactionService.getTransactionById(anyLong())).thenThrow(new ResourceNotFoundException("Transaction not found with id 1"));
